...
- [~] LOOP 05 — Hero + QA final (H1/H2 corregidos, H3 resuelto en LOOP 11).
- [~] LOOP 10 — Contacto/CTA (gradiente de alto contraste, botón sin href por falta de canal de contacto).
...
- [ ] Decidir si Servicios necesita un título visible de marketing (LOOP 09).
